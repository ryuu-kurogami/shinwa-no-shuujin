  ...
  secciones: [
    {
      ...
      parrafos: [
        ...
        "Por este motivo, el Sitio no persigue fines de lucro personal para el Administrador — aunque, como se aclara en la Sección 5, esto no implica que Shinwa no Shuujin constituya legalmente una organización sin fines de lucro ni una entidad benéfica registrada.",
