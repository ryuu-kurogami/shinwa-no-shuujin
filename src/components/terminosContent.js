  ...
  secciones: [
    {
      ...
      parrafos: [
        ...
        "El objetivo principal del Sitio no es generar ingresos, sino ofrecer una alternativa gratuita donde cualquier persona pueda leer y compartir buenas historias ademas de compartir un poco del amor a este bello arte. Por esta misma razón existe también un espacio dedicado a fanfics, pensado para quienes buscan pasar un buen rato con relatos basados en universos que ya aman. Shinwa no Shuujin busca ser un punto de encuentro entre quienes disfrutan de la lectura y la escritura — un espacio de comunión alejado del ritmo caótico del día a día.",
        "Por este motivo, el Sitio no persigue un objetivo de lucro para el Administrador — aunque en el transcurso pueda llegar a obtener remuneración a futuro, y como se aclara en la Sección 5, esto no implica que Shinwa no Shuujin constituya como una organización lucrativa o no lucrativa, sino que va mas alla de ello buscando generar un impacto en las personas mediante este arte.",
    ...
    {
      encabezado: "5. Apoyos Económicos y de cualquier otra índole",
      parrafos: [
        { numero: "5.1.", texto: "Apoyo a autores: los autores registrados pueden incluir en su perfil un enlace externo provisto por ellos mismos, a través del cual los lectores pueden realizar contribuciones voluntarias como forma de apoyo. La Plataforma no procesa, gestiona ni tiene acceso a estas transacciones. El Administrador no asume ninguna responsabilidad sobre dichas transacciones." },
        { numero: "5.2.", texto: "Apoyo al Sitio: la Plataforma cuenta además con una sección de contribuciones generales, destinadas exclusivamente al mantenimiento y mejora del Sitio. El Sitio publica de forma pública y actualizada (ver /transparencia) el monto total recibido, el destino de dichos fondos, y el monto que permanece reservado." },
        ...
        { numero: "5.4.", texto: "Naturaleza opcional de los aportes: tanto las donaciones a autores como las donaciones al Sitio son enteramente voluntarias y están pensadas para apoyar el contenido, no para venderlo. Queda prohibido condicionar la publicación de nuevos capítulos o contenido a algún tipo de pago dentro del Sitio. Cualquier acuerdo económico que un autor realice con lectores fuera de la Plataforma es de su exclusiva responsabilidad." },
        { numero: "5.5.", texto: "Estatus del proyecto ante los aportes: Shinwa no Shuujin no constituye una organización sin fines de lucro registrada ni una entidad jurídica benéfica — es un proyecto independiente y personal (ver Sección 1). Los aportes que la comunidad realice a través de plataformas de terceros (como Ko-fi o PayPal) son contribuciones totalmente voluntarias destinadas al apoyo y subsistencia del Administrador y al desarrollo y mejoramiento continuo de la Plataforma. Ningún aporte constituye una inversión, una compra de acciones, ni un pago por servicios garantizados, salvo los beneficios expresamente indicados en dichas plataformas externas." },
        { numero: "5.6.", texto: "Uso de los fondos en la fase actual: durante esta etapa inicial, los fondos recaudados a través de las donaciones al Sitio (ver 5.2) se destinan exclusivamente a cubrir costos operativos, de infraestructura web, alojamiento de datos (servidores y bases de datos), y mantenimiento técnico de la Plataforma." },
        { numero: "5.7.", texto: "Evolución futura y monetización: nos reservamos el derecho de implementar en el futuro nuevas herramientas de monetización, sistemas de suscripción, o esquemas de remuneración dirigidos a recompensar económicamente a los autores y creadores que publican sus obras en Shinwa no Shuujin. Los aportes actuales constituyen la base tecnológica que permitirá, eventualmente, escalar el proyecto hacia ese objetivo buscando que cada autor en futuro reciba un pago correspondiente a su obra." },
      ],
    },
    {
    ...
    },
    {
      ...
      parrafos: [
        ...
        { numero: "9.3.", texto: "Este documento se rige primordialmente por las leyes de la República del Paraguay, las cuales se interpretan conforme a la normativa vigente en dicho país, lugar de residencia del administrador y sede de operación." },
      ],
    },
    {
    ...
    },
    {
      ...
      parrafos: [
        "Para consultas, reportes, o solicitudes relacionadas con estos Términos, podés contactar al Administrador a través del correo soporte.shinwanoshuujin@gmail.com.",
      ],
    },
  ],
};